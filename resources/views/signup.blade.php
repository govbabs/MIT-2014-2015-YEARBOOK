                ...
                <section class="panel panel-default paper-shadow" data-z="0.5">
                                    ...
                                    <div class="panel-body">
                                      ...
                                      <div class="form-group">
                                          <div class="form-control-material">
                                            <input id="firstName" type="text" class="form-control" placeholder="Enter your Matric Number here">
                                        ...
                                        <div class="text-right">
                                          <a href="student-profile.blade.php" class="btn btn-primary">Create an Account</a>
                                        </div>
                                      </form>
                    ...
                    <div class="#">
                            ...
                            <ol class="breadcrumb text-right">
                              <li><a href="login.blade.php" class="link-text-color">Sign in</a></li>
                                    <li class="forgot-password"><a href="password.html">Forgot password?</a></li>
