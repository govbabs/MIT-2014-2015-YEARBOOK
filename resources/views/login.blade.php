            ...
            <div class="lock-container">
                <section class="panel panel-default paper-shadow" data-z="0.5">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <a href="student-profile.blade.php" class="btn btn-primary text-right">Login <i class="fa fa-fw fa-unlock-alt"></i></a>
                                        </div>
                    ...
                    <div class="#">
                            ...
                            <ol class="breadcrumb">
                              <li><a href="signup.blade.php" class="link-text-color">Create account</a></li>
                                    <li class="forgot-password"><a href="recover.blade.php">Forgot password?</a></li>
