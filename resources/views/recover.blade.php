...
<section class="panel panel-default paper-shadow" data-z="0.5">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <a href="student-profile.blade.php" class="btn btn-primary text-right">Recover<i class="fa fa-fw fa-unlock-alt"></i></a>
                                        </div>
                    ...
                    <div class="text-center">
                            ...
                            <ol class="breadcrumb">
                              <li><a href="login.blade.php" class="link-text-color"><i class="fa fa-fw fa-chevron-left"></i>Cancel and go back to login page.</a></li>
