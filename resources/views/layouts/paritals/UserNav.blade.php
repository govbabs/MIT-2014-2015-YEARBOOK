 ...
 */
?>
<div class="navbar navbar-default navbar-fixed-top navbar-size-large navbar-size-xlarge paper-shadow"
                ...
                <ul class="nav navbar-nav navbar-nav-bordered navbar-nav-margin-right">
                    ...
                    <li class="dropdown user active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="images/chid.jpg" alt="" class="img-circle" /> {{ Auth::user()->username }}<span class="caret"></span>
                        </a>
